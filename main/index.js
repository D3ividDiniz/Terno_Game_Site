...
function venceu(){
    ...
    score += Math.abs((position-30)*60+5);
...
sort_pa = palavras[Math.floor(Math.random()*3)];
sortd_pa = sort_pa[Math.floor(Math.random()*sort_pa.length)];
